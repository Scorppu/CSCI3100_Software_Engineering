...
class PokemanTrainingStats:
    def __init__(self, level: int, hp: int, attack: int, defence: int, speed: int):
        self.level = level
        self.hp = hp
        self.attack = attack
...
class Pokeman(Trainable):
    ...
    def update_stats(self, stats: PokemanTrainingStats):
